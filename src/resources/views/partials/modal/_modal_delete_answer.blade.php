<div class="modal fade" id="deleteModalAnswer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <form id="deleteForm" action="/admin/delete-answer/{{ $answer->id }}" method="POST">
                    @csrf
                    @method('DELETE')
